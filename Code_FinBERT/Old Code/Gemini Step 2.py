...
# Load rubric text for prepend (summarized methodology)
with open("/Users/lucaschmidt/Desktop/PhD_Rasa/My Papers/summarized_lesg_esg_methodology.txt", "r") as f:
...
output_path = "/Users/lucaschmidt/Desktop/PhD_Rasa/My Papers/Gemini Output/gemini_step2a_output.xlsx"

# Prompt template
system_prompt = (
    "You are a professional ESG analyst.\n"
    "Based on the following ESG scoring rubric and disclosure content, estimate an ESG score from 0 (worst) to 100 (best).\n"
...
for idx, filename in enumerate(files, 1):
    ...
    if response.status_code == 200:
        try:
            ...
            score = round(min(max(float(text.strip().replace("%", "")), 0), 100), 2)
        except Exception:
            score = None
